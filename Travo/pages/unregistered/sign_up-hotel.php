...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="../../script/unregistered/sign_up_hotels.js"></script>
    <!-- This code will run after the body tag  -->
    <script defer src="../../script/unregistered/sign_up_hotels2.js"></script>  
    <script defer src="../../script/unregistered/sign_up_hotels45.js"></script> 
  </head>
  <body>
    ...
    <div id="error"></div>
      <form class="form-sign_up-traveler" id = "sign_up_form-hotel" name="sign_up_form-hotel"action="../../php/unregistered/signup_submit_hotel.php" method="post">
        ...
        <input class="text-small-form-sign_up-traveler" type="password" name="retype-password" id="retype-password" value= "" onkeyup='check();' ><input class="text-small-form-sign_up-traveler" type="password" name="password" id="password" value="" > <span id='message'></span> <br>
        <br>
      ...
      <table class="room_details-form-sign_up-hotel">
             ...
             <br>
  <input class="tc-checkbox-form-sign_up-traveler" type="checkbox" name="tc" id="tc" value="">
