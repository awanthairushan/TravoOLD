...
<html>
    ...
    <body>
        ...
        <form method="post" id="payForm" name="payForm" class="payForm" action="https://sandbox.payhere.lk/pay/checkout">   
            ...
            <input type="text" name="return_url" value="https://localhost/Travo3/pages/traveler/traveler_trip_to_go.php">
            <input type="text" name="cancel_url" value="https://localhost/Travo3/pages/traveler/traveler_budget.php">
            <input type="text" name="notify_url" value="https://localhost/Travo3/php/traveler/traveler_payment.php">  
